...
public class CalendarUtil {
	...
	public static Date nextMonthDate(Date date) {
		...
		if (result.getMonth() != newMonth) {
			/*
			 * If the date was January 31, for example, and the month is set to
			 * February, then the new date will be treated as if it were on
			 * March 3, because February has only 30 days.
			 */
