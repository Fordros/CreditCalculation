...
public interface CreditOffer {
	...
	/**
	 * @return величина ежемесячной комиссии (независимой от процента
	 ...
	 */
	CreditProposal calculateProposal(Credit application);

	/**
	 * Устанавливает ставку оффера по кредиту, в долях от единицы.
	 *
	 * @param rate
	 *            ставка в долях от единицы (0.1699 соответствует 16.99%).
	 ...
	 *
	 * @param onceCommissionAmount
	 *            размер единовременной комиссии.
	 * @return оффер, в целях fluent interface.
	 */
	 ...
	 *
	 * @param onceCommissionPercent
	 *            процент единовременной комиссии.
	 * @return оффер, в целях fluent interface.
	 */
	 ...
	 *
	 * @param monthlyCommissPercent
	 *            процент ежемесячной комиссии в долях от единицы.
	 * @return оффер, в целях fluent interface.
	 */
